...
# Creates and returns and Ellipse
def add_Ellipse(ep):
...
if plot_lobes_flag:
    ...
    for first_el in to_ellipse_patch:
        ellip = add_Ellipse(first_el)
        ax.add_patch(ellip)

    for second_el in to_ellipse_patch2:
        ellip = add_Ellipse(second_el)
        ax.add_patch(ellip)
